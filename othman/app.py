...
def getWeather():
    try:
        ...
        if temp > 30:
            logo.config(image=PhotoImage(file="sunny.png"))
            t.config(fg="red")
            c.config(fg="red")
        else:
            t.config(fg="blue")
...
myimage_icon = Button(
    image=Search_icon, borderwidth=0, cursor="hand2", bg="black", command=getWeather
)
myimage_icon.place(x=400 + int(search_box_y), y=34)
...
# label
label1 = Label(
    root, text="WIND", font=("Helvetica", 15, "bold"), fg="white", bg="#111111"
)
label1.place(x=120, y=400)
label2 = Label(
    root, text="HUMIDITY", font=("Helvetica", 15, "bold"), fg="white", bg="#111111"
)
label2.place(x=250, y=400)
label3 = Label(
    root, text="DESCIPTION", font=("Helvetica", 15, "bold"), fg="white", bg="#111111"
)
label3.place(x=430, y=400)
label4 = Label(
    root, text="PRESSURE", font=("Helvetica", 15, "bold"), fg="white", bg="#111111"
)
label4.place(x=650, y=400)
